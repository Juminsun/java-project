...
{   
   ...
   public SalaryPopup()
   {
      ...
      int health=200;
      String str1 = null;
      String str2 = String.format("%,d", health);
      ...
      //text[0].setText("< 소유한 과목 목록 >");
      //text[0].setBounds(0, 40, 500, 30);
      //text[1].setText(str1);
      text[1].setBounds(0, 75, 500, 30);
      text[2].setText("한 턴이 끝났습니다! " + str2 + "의 체력 지급됩니다.");
      //text[2].setText("한바퀴 돌았습니다! 체력이 지급됩니다!!");
      ...
      yes.addActionListener(new ActionListener() {
         public void actionPerformed(ActionEvent e) {
            ...
            MarbleGame.p[MarbleManager.pnum].setMoney(MarbleGame.p[MarbleManager.pnum].getMoney()+health); // 월급 지급
