...
public class BuyPopup extends JDialog
{
	...
	public BuyPopup()
	{
		...
		text[1].setText("과목이 요구하는 체력은" + str + " 입니다.");
		text[1].setBounds(0, 75, 500, 30);
		text[2].setText("획득하시겠습니까?");
		...
		yes.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				{
					JOptionPane.showMessageDialog(MarbleGame.jlp, "체력이 부족합니다. 획득할 수 없습니다.", "결과", JOptionPane.ERROR_MESSAGE);
					return;
				}
				else
					if(MarbleGame.pst[MarbleManager.pnum][0] == 0)
						...
						if(MarbleGame.pst[MarbleManager.pnum][1] == 0)
							...
							{
								JOptionPane.showMessageDialog(MarbleGame.jlp, "과목을 더 이상 획득할 수 없습니다.", "결과", JOptionPane.ERROR_MESSAGE);
								return;
							}
				...
				JOptionPane.showMessageDialog(MarbleGame.jlp, "획득 성공하였습니다. 축하합니다.", "결과", JOptionPane.INFORMATION_MESSAGE);
