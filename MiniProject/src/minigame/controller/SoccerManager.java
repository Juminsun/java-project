...
{		
	...
	public void compare(int gknum, int posinum)
	{
		if(gknum != posinum)
		{
			...
			JOptionPane.showMessageDialog(SoccerGame.jlp, "성공! ", "        ", JOptionPane.INFORMATION_MESSAGE);
		}
		else
		{
			...
			SoccerGame.jlp.add(result, new Integer(4));
			result.setVisible(true);
			JOptionPane.showMessageDialog(SoccerGame.jlp, "패배..", "        ", JOptionPane.ERROR_MESSAGE);
		}
	}
}